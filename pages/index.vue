  ...
  <div class="isolate bg-white">
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <stop offset="1" stop-color="#fce9c7" />
          </linearGradient>
        </defs>
      </svg>
    </div>
    ...
    <main>
      <div class="relative px-6 lg:px-8">
        <div class="mx-auto py-24 sm:py-36 lg:py-48">
          ...
          <div class="text-center">
            ...
            <p class="mx-auto mt-6 max-w-3xl text-lg leading-8 text-gray-600">
              ...
              voting and governance platform for transparent and inclusive
              decision-making
            </p>
